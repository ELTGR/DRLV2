...
class UnityEnv(gym.Env):
        ...
        self.observation_space = Dict(
                    {
                        ...
                        #X Y Z arrive
                        'pos_arrive' : spaces.Box(low=float("inf"), high=float("inf"), shape=(3,), dtype=np.float32),
                        #X Y Z ma_pos
    ...
    def get_observation(self):
        ...
        dict_obs['pos_arrive'] = np.array([self.position_goal], dtype=int)
    ...
    def reward(self) : 
        ...
        current_dist_to_goal = np.linalg.norm(positon_goal- positon_cur)
    ...
    def step(self, action):
        ...
        action_tairt=sample_acttion['mode_trait']
        action_dep=sample_acttion['case_suivante']

        self.cur_action_tr = action_tairt
        self.cur_action_dep = action_dep
