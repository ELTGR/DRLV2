...
def scan(cur_pos=[10,10],next_pos=[10,20]):  # pragma: no cover
    print("start!!")
    x_start=cur_pos[0]
    y_start=cur_pos[1]
    ...
    x_end=next_pos[0]
    y_end=next_pos[1]
    #ox = [0.0, 10,20, 20, 65, 20, 0.0]
    #oy = [0.0, -10.0, 0.0, 15.0, 30.0, 40.0, 0.0]
    #oz = [5]
    #resolution = 5
    ...
    ox = [x_start+10, x_start-10, x_start-10, x_start, x_start+10, x_start+10]
    oy = [y_start+10, y_start+10, y_start, y_start, y_start, y_start+10]
    oz = [5]
    resolution = 2
   ...
   # ox = [0.0, 20.0, 50.0, 200.0, 130.0, 40.0, 0.0]
    ...
    px, py= planning(ox, oy, resolution)
    px2=np.empty(len(px)+1)
    py2=np.empty(len(px)+1)
    ...
    ix=np.empty(len(ox))+1
    ix.fill(oz[0])
    oz=ix
    Z=np.empty(len(px2))
    Z.fill(oz[0])
    Drone(px2, py2, Z, ox, oy, oz)
