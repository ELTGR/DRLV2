...
class Quadrotor():
    def __init__(self, mx, my, mz, ox, oy, oz, x=0, y=0, z=0, roll=0, pitch=0, yaw=0, size=0.25, show_animation=True):
        ...
        self.update_pose(x, y, z, roll, pitch, yaw, mx, my, mz, ox, oy, oz)

    def update_pose(self, x, y, z, roll, pitch, yaw, mx, my, mz, ox, oy, oz):
        self.x = x
        self.y = y
        self.z = z
        self.maxx=mx
    ...
    def plot(self):  # pragma: no cover
        ...
        self.ax.plot(self.ox, self.oy, self.oz, '-b')
